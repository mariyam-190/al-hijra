                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                          <h2 class="mb-2 text-right"><strong>مرحبا بك في لوحة التحكم لشركة الهجرة للدواجن </strong></h2>
<p class="pageheader-text">Lorem ipsum dolor sit ametllam fermentum ipsum eu porta consectetur adipiscing elit.Nullam vehicula nulla ut egestas rhoncus.</p>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="text-muted"><strong>حركة الانتاج </strong></h5>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="text-muted"><strong>معدل الوفيات</strong></h5>
                                <div class="metric-value d-inline-block">
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="text-muted"><strong>الحالة الصحية</strong></h5>
                                <div class="metric-value d-inline-block">
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="text-muted"><strong>نمو القطيع</strong></h5>
                                <div class="metric-value d-inline-block">
                ...
                <div class="row">
                    <div class="col-xl-8 col-lg-12 col-md-8 col-sm-12 col-12">
                        <div class="card">
                          <h2 class="card-header"><strong>الايرادات والمصروفات</strong></h2>
<div class="card-body">
              <canvas id="revenue" width="400" height="150"></canvas>
                            ...
                            <div class="card-body border-top">
                                <div class="row">
                                  <div class="offset-xl-1 col-xl-3 col-lg-3 col-md-12 col-sm-12 col-12 p-3">
                                    <h4> <strong> اجمالي الربحية: $2,800.30</strong></h4>
                                    </div>
                                    <div class="offset-xl-1 col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12 p-3">
                                        <h2 class="font-weight-normal mb-3"><span>$48,325</span>                                                    </h2>
                                        <div class="mb-0 mt-3 legend-item">
                                            <span class="fa-xs text-primary mr-1 legend-title "><i class="fa fa-fw fa-square-full"></i></span>
                                            <span class="legend-text">(current week)  الايرادات</span></div>
                                  </div>
                                    <div class="offset-xl-1 col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12 p-3">
                                        ...
                                        <div class="text-muted mb-0 mt-3 legend-item"> <span class="fa-xs text-secondary mr-1 legend-title"><i class="fa fa-fw fa-square-full"></i></span><span class="legend-text">(previous week)المصروفات</span></div>
                                    </div>
                                </div>
                            </div>
                      </div>
                    ...
                    <div class="col-xl-4 col-lg-12 col-md-4 col-sm-12 col-12">
                        <div class="card">
                            <h2 class="card-header"><strong>مخزون البيض</strong></h2>
<div class="card-body">
              <canvas id="total-sale" width="220" height="155"></canvas>
                                <div class="chart-widget-list">
                                    <p>
                                        <span class="fa-xs text-primary mr-1 legend-title"><i class="fa fa-fw fa-square-full"></i></span><span class="legend-text"> طابق</span>
                                    ...
                                    <p>
                                        ...
                                        <span class="legend-text">انشق</span>
                                        <span class="float-right">135.18</span>
                                    </p>
                                    <p>
                                        <span class="fa-xs text-brand mr-1 legend-title"><i class="fa fa-fw fa-square-full"></i></span> <span class="legend-text">استهلاك</span>
                                        <span class="float-right">48.96</span>
                                    </p>
                                    <p class="mb-0">
                                        <span class="fa-xs text-info mr-1 legend-title"><i class="fa fa-fw fa-square-full"></i></span> <span class="legend-text">مزدوج</span>
...
<div class="card">
    <h5 class="card-header"><strong>توصيل البيض يوميا</strong></h5>
    <div class="card-body">
        ...
        <div class="row">
            <div class="col-xl-6">
                <div class="sell-ratio">
                    <h5 class="mb-1 mt-0 font-weight-normal">البيض المبائع</h5>
                    ...
                    <!-- ============================================================== -->
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                <div class="card border-3 border-top border-top-primary">
                                    <div class="card-body">
                                        <h5 class="text-muted"><strong>اجمالي الايرادات</strong></h5>
                                        <div class="metric-value d-inline-block">
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                <div class="card border-3 border-top border-top-primary">
                                    <div class="card-body">
                                        <h5 class="text-muted"><strong>اجمالي المصروفات</strong></h5>
                                        <div class="metric-value d-inline-block">
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                <div class="card border-3 border-top border-top-primary">
                                    <div class="card-body">
                                        <h5 class="text-muted"><strong>تقدير تكلفة البيضة</strong></h5>
                                        <div class="metric-value d-inline-block">
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                <div class="card border-3 border-top border-top-primary">
                                    <div class="card-body">
                                        <h5 class="text-muted"><strong>اجمالي الطلبات</strong></h5>
                                        <div class="metric-value d-inline-block">
