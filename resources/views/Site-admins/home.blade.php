	            ...
	            <div class="collapse navbar-collapse " id="navbarSupportedContent">
	                <ul class="navbar-nav ml-auto navbar-right-top">
	                    ...
	                    <li class="nav-item dropdown nav-user">
	                        <a class="nav-link nav-user-img" href="#" id="navbarDropdownMenuLink2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="assets/images/دواجن.jpg" alt="" class="user-avatar-md rounded-circle"></a>
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-10" aria-controls="submenu-10"><i class="fas fa-f fa-folder"></i>اضافة قطيع</a>
	                ...
	                <div class="row">
	                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
	                        <div class="page-header">
	                            <h2 class="mb-2 text-right"><strong>مرحبا بك في لوحة تحكم لمدراء المواقع لشركة الهجرة للدواجن </strong></h2>
<p class="pageheader-text">Proin placerat ante duiullam scelerisque a velit ac porta, fusce sit amet vestibulum mi. Morbi lobortis pulvinar quam.</p>
	                ...
	                <div class="row">
	                    ...
	                    <div class="row">
	                        ...
	                        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
	                            <div class="card">
	                                <div class="card-body">
	                                    <div class="d-inline-block">
                                          <h1 class="text-muted"><strong><a href="."> التقارير</a></strong></h1>
                                        </div>
							  ...
							  <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
	                            <div class="card">
	                                <div class="card-body">
	                                    <div class="d-inline-block">
                                          <h1 class="text-muted text-right"><strong><a href=".">مرحلة الانتاج</a></strong></h1>
                                        </div>
							 ...
							 <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
	                            <div class="card">
	                                <div class="card-body">
	                                    <div class="d-inline-block">
                                          <h1 class="text-muted text-right"><strong><a href="table.html">ادخال البيانات </a></strong></h1>
                                        </div>
	                                    <div class="float-right icon-circle-medium  icon-box-lg  bg-brand-light mt-1">
	                                    </div>
	                                </div>
							 ...
							 <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
	                            <div class="card">
	                                <div class="card-body">
	                                    <div class="d-inline-block">
                                          <h1 class="text-muted text-right"><strong><a href="."> بيانات البيض</a></strong></h1>
                                        </div>
	                                    <div class="float-right icon-circle-medium  icon-box-lg  bg-brand-light mt-1">
	                                    </div>
	                                </div>
							 ...
							 <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
	                            <div class="card">
	                                <div class="card-body">
	                                    <div class="d-inline-block">
                                          <h2 class="text-muted text-right"><strong><a href=".">افادة بحالة صحية </a> </strong></h2>
                                        </div>
	                                    <div class="float-right icon-circle-medium  icon-box-lg  bg-brand-light mt-1">
	                                    </div>
	                                </div>
	                        ...
	                        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
	                            <div class="card">
	                                <div class="card-body">
	                                    <div class="d-inline-block">
                                          <h1 class="text-muted text-right"><strong> <a href="."> استعلامات</a></strong></h1>
                                        </div>
	                        ...
	                        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
	                            <div class="card">
	                                <div class="card-body">
	                                    <div class="d-inline-block">
                                          <h1 class="text-muted text-center"><strong><a href="."> تعديل البيانات</a></strong></h1>
                                        </div>
	                        ...
	                        <!-- ============================================================== -->
							 <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
	                            <div class="card">
	                                <div class="card-body">
	                                    <div class="d-inline-block">
                                          <h1 class="text-muted text-right"><strong><a href="."> طلب توريد</a></strong></h1>
                                        </div>
	                                    <div class="float-right icon-circle-medium  icon-box-lg  bg-brand-light mt-1">
	                                    </div>
	                                </div>
	                    ...
	                    <div class="row">
	                        ...
	                        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
	                            <div class="card">
	                                <h3 class="card-header text-center"><strong>افراد القطيع</strong></h3>
<div class="card-body">
                <div id="gender_donut" style="height: 230px;"></div>
	                                ...
	                                <div class="card-footer p-0 bg-white d-flex">
	                                    <div class="card-footer-item card-footer-item-bordered w-50">
	                                        <h2 class="mb-0"> 60% </h2>
	                                        <p><strong>الاناث</strong> </p>
	                                    </div>
	                                    <div class="card-footer-item card-footer-item-bordered">
	                                        <h2 class="mb-0">40% </h2>
	                                        <p><strong>الذكور</strong> </p>
	                                    </div>
	                                </div>
	                            </div>
	                        </div>
	                        ...
	                        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
	                            <div class="card">
	                                <h3 class="card-header text-center"><strong>انتاجية القطيع</strong></h3>
<div class="card-body">
                  <div class="mb-3">
	                                        <div class="d-inline-block">
	                        ...
	                        <div class="col-xl-5 col-lg-12 col-md-6 col-sm-12 col-12">
	                            <div class="card">
	                                <h2 class="card-header text-center"><strong>المبيعات</strong></h2>
<div class="card-body">
	                    ...
	                    <div class="row">
	                        ...
	                        <div class="col-lg-12">
	                            <div class="section-block">
	                                <h3 class="section-title"><strong>جدول بيانات القطعان</strong></h3>
	                            </div>
	                            <div class="card">
	           <div class="col-xl-12 col-lg-12 col-md-6 col-sm-12 col-12">
                                        ...
                                        <div class="table-responsive">
                                          <table class="table">
                                            ...
                                            <tbody>
                                                    ...
                                                    <tr>
                                                        <td colspan="9"><a href="#" class="btn btn-outline-light float-right"><strong>اضافة قطيع</strong></a>
												</td>
											</tr>
                                            </tbody>
                                          </table>
	                    ...
	                    <div class="row">
	                        <div class="col-lg-12">
	                            <div class="section-block">
                                  <h2 class="section-title"><strong>مخزون الاعلاف</strong></h2>
                                </div>
	                        </div>
	                        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
	                            <div class="card campaign-card text-center">
	                                <div class="card-body">
	                                    <div class="campaign-img"><img src="assets/images/23.png" alt="user" class="user-avatar-xl"></div>
	                                        <div class="campaign-info">
	                                            <h3 class="mb-1"><strong>اعلاف القطيع</strong></h3>
	                            ...
	                            <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
	                                <div class="card campaign-card text-center">
	                                    <div class="card-body">
	                                        <div class="campaign-img"><img src="assets/images/MN.jpg" alt="user" class=" user-avatar-xl"></div>
	                                            <div class="campaign-info">
	                                                <h3 class="mb-1"><strong>انارة المزرعة</strong></h3>
	                                ...
	                                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
	                                    <div class="card campaign-card text-center">
	                                        <div class="card-body">
	                                            <div class="campaign-img"><img src="assets/images/ما-هو-تطعيم-النيوكاسل-واهميتة.jpeg" alt="user" class="user-avatar-xl"></div>
	                                                <div class="campaign-info">
	                                                    <h3 class="mb-1"><strong>لقاحات القطيع</strong></h3>
